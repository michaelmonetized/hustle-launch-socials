 ...
 * @abstract
 */
abstract class HLSocials_Field {
	...
	public function get_value() {
		global $hlsocials;
		$field_data = $hlsocials->get_form()->get_field_data();
		$original_name = str_replace('hlsocials_', '', $this->get_id());
